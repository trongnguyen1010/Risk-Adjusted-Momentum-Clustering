...
| **A3. Nguyen, Thu Hang (2012), “Momentum Effect in the Vietnamese Stock Market”, Procedia Economics and Finance 2, 179–190, DOI 10.1016/S2212-5671(12)00078-0.** Lý do đọc gốc: xem momentum có thể yếu sau risk adjustment. | PENDING — FULL-TEXT REVIEW | PENDING — FULL-TEXT REVIEW | PENDING — FULL-TEXT REVIEW | Candidate caveat cho momentum; không suy result trước review. Bibliographic identity được sửa theo publisher metadata; evidence status của matrix này không tự nâng. |
