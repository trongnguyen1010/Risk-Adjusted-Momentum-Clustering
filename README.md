...
|---|---|
| **M1 — Data Foundation** | `SOURCE_SMOKE` và real `REPRESENTATIVE_PILOT` 55 mã đã PASS. `M1_SCALE` chỉ mới unlock cho planning, chưa chạy. Financial vẫn `RAW_ONLY_PIT_UNRESOLVED`. |
