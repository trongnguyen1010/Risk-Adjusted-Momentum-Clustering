...
Verifier đọc artifact bất biến, kiểm tra 19 output hash, upstream manifest/identity hash và năm source ZIP. Nó không gọi network, không chạy supplemental acquisition và không rebuild feature.
