...
from delta_t1.ingestion.sources.vnstock import date_batches, worker, collect
...
class FormulaTests(unittest.TestCase):
    def test_sdk_worker_runs_in_staging_directory(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            with patch('delta_t1.ingestion.sources.vnstock.importlib.metadata.version',return_value='4.0.6'), patch('delta_t1.ingestion.sources.vnstock.subprocess.run',side_effect=fake_run), patch('time.sleep'):
    ...
    def test_sdk_explicit_range_is_not_truncated_at_100(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            with patch.dict(sys.modules,{'vnstock':fake}), patch('delta_t1.ingestion.sources.vnstock.importlib.metadata.version',return_value='4.0.6'):
                worker(inp,out)
...
class HTTPTests(unittest.TestCase):
    ...
    def test_retry_429(self):
        with patch('delta_t1.ingestion.sources.base.time.sleep'):
